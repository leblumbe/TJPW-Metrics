    ...
    if(this_event$`Match Type`[i] == "3 Way"){
      ...
      if(this_event$Decision[i] == "Time Limit Draw"){
        ...
        if(this_event$`W3 Result`[i] == "L*"){
          ...
          new_ratings[W1-2] = new_rating_threeway(prior_ratings[W1-2], prior_ratings[W2-2], prior_ratings[W3-2], 2/3)
          new_ratings[W2-2] = new_rating_threeway(prior_ratings[W2-2], prior_ratings[W1-2], prior_ratings[W3-2], 0)
          new_ratings[W3-2] = new_rating_threeway(prior_ratings[W3-2], prior_ratings[W2-2], prior_ratings[W1-2], 1/3)
        }
      }
...
Ratings.long %>% 
  ...
  labs(title = "TJPW Elo Ratings v2.2 2013-2015",
       subtitle = "s=400, k=20, 1v1, 2v2, and 3v3 Matches Only, Starting Value 1500")
...
long.2015 %>% 
  ...
  scale_color_viridis_d() +
  geom_hline(yintercept = 1500) +
  labs(title = "TJPW Elo Ratings v2.2 2013-2015 (only active at end 2015)",
       subtitle = "s=400, k=20, 1v1, 2v2, and 3v3 Matches Only, Starting Value 1500")
```
...
end2015 = Ratings[47, 3:21]
Ratings.v2.3 = Ratings
```
