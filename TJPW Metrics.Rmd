...
#V2.4.1 (Added Double Countouts as Draws)
...
Ratings.long %>% 
  ...
  labs(title = "TJPW Elo Ratings v2.4.1 2013-2017",
...
long.2017 %>% 
  ...
  scale_color_viridis_d() +
  geom_hline(yintercept = 1500) +
  labs(title = "TJPW Elo Ratings v2.4.1 2013-2017 (only active in 2017)",
       subtitle = "s=400, k=20, Starting Value 1500")
```
